...
public class UDPServerHandler {
    ...
    public void start() {
        ...
        appendLog("Spike: > 2x previous record");
        appendLog("----------------------------------------\n");
        ...
        while (running) {
            try {
                ...
                processRecord(received, senderInfo);
    ...
    private void processRecord(String data, String senderInfo) {
        totalRecords++;
        ...
        if (parts.length >= 6) {
            ...
            appendLog(String.format("Temp: %.1f C | Humidity: %.1f%% | Motion: %s", temperature, humidity, motion));
    ...
    private void printFinalReport() {
        ...
        appendLog("Highest Power: " + String.format("%.2f", highestPower) + " kWh from " + highestSender + " at " + highestTimestamp);
